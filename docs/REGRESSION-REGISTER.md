...
|---|---|---|---|---|
| Issue 80 normalization | Board or revision tokens can remain in normalized game keys. | Affected folder names normalize to the same key as their canonical title. | `Tests/KnownBugRegression.Tests.ps1` | Pending Fix |
