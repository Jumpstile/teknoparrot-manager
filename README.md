...
*Not in v1.0 RC1 -- implemented ahead of time on its own branch, targeting v1.1.* The menu
above will automatically adjust its level of detail to your console window size instead of
